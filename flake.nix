{
  ...
  inputs = {
    ...
    cardano-node = {
      url =
        "github:input-output-hk/cardano-node/9f1d7dc163ee66410d912e48509d6a2300cfa68a";
    };
    cardano-prelude = {
      url =
    ...
    hedgehog-extras = {
      url =
        "github:input-output-hk/hedgehog-extras/967d79533c21e33387d0227a5f6cc185203fe658";
      flake = false;
    };
    hjsonpointer = {
      url =
        "github:KtorZ/hjsonpointer/879f0e74d55eef76ceaec8f60ed07657ab84bad7";
      flake = false;
    };
    hjsonschema = {
      url =
        "github:KtorZ/hjsonschema/35e0b05c3867463363e67f00a5092cd39fa33313";
      flake = false;
    };
